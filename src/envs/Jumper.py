...
class Player():
    ...
    def Render(self, gameDisplay):
        ...
        rx = self.size * displayWidth;
        ry = self.size * displayHeight
...
class JumperEnv():
    ...
    def render(self, gameDisplay):
        ...
        pygame.draw.rect(gameDisplay, (120, 120, 120),
                         [0, (1 - self.floor) * displayHeight, displayWidth, displayHeight])
        ...
        rx = self.player.size * displayWidth;
        ry = self.player.size * displayHeight
